...
public class MainWindowController {
    ...
    public void toRuleThemAll(Watchable m) { //bedste metode i verdenen :)
        InputStream in = MainWindowController.class.getResourceAsStream("pictures/" + m.getTitle() + ".jpg"); //henter vores billeder.
        Image image = new Image(in);   //opretter et billede med ovenstående fil
